...
class CircleMemberAdapter(private val mContext: Context,
                          private val mUser:List<UserModel>,
                          private val circleId:String,
                          private val admin:String):RecyclerView.Adapter<CircleMemberAdapter.ViewHolder>() {

                              inner class ViewHolder(@NonNull itemView: View):RecyclerView.ViewHolder(itemView){
                                  val profileImage:CircleImageView = itemView.findViewById(R.id.profileImage_member) as CircleImageView
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(mContext).inflate(R.layout.circle_members_layout, parent,false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.addMember.setOnClickListener {
            if (mUser[position].private){
                Toast.makeText(mContext,"You cannot add private accounts",Toast.LENGTH_SHORT).show()
            }else{
